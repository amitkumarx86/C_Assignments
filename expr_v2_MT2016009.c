        ...
        if(var1 == '('){
            ...
            while(var2 != ')'){
                ...
                if(isdigit(var2)){
                    ...
                    operator = pop();
                    tempVar = pop();
                    if(tempVar == 'x' || tempVar == 'y')   
                    secondOperand = value;
                    else
                        secondOperand = tempVar - '0';
                }
    		...
    		//printf("compute2= %d",compute[index]);
                ...
                if(var2 == '('){
                    // Activation data
                    int tempFirstData = result;
                    char tempOperator = var1;
                    ...
                    result = computation(tempFirstData, tempOperator, result);
                    //printf("result= %d and index = %d\n",result,index);
                }
                else
                {
        	    ...
        	    //printf("computation123, tmp = %d, var1 = %c, var 2= %d\n",firstOperand,var1,secondOperand );
